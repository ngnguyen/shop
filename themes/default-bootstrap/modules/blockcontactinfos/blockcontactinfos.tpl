        ...
        <ul class="toggle-footer">
            {if $blockcontactinfos_company != ''}
            	<li>
                    ...
                    {$blockcontactinfos_company|escape:'html':'UTF-8'}<br/>
            ...
            {if $blockcontactinfos_phone != ''}
            	<li>
                    ...
                    <img src="/shop/img/icons/call.png" />{l s='' mod='blockcontactinfos'}
            ...
            {if $blockcontactinfos_email != ''}
            	<li>
                    ...
                    <img src="/shop/img/icons/mouse.png" />{l s='' mod='blockcontactinfos'}
